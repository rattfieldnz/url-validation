...
/**
 * This class is used to get valid
 * URL protocols and extensions.
 *
 * Class UrlComponents
...
class UrlComponents {
     ...
     */
    public static function protocolsToString()
    {
        $protocols_string = Helpers::arrayToString(self::urlProtocols());

        return Helpers::replaceCharacters($protocols_string, ",", "|");
    }
     ...
     * @uses Helpers::replaceCharacters
     */
    public static function extensionsToString()
    {
        $extensions_string = Helpers::arrayToString(self::urlExtensions());

        return Helpers::replaceCharacters($extensions_string, ",", "|");
    }

    /**
     * This returns URL protocols to be
     * used in validation.
     * @return array
     */
    public static function urlProtocols()
    {
        return ["http", "https"];
    }
